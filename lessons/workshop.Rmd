...
From Challenge 1 you should have gotten code that looks something like this:
```{r}
...
1. It loads `ggplot2` because it knows we need it for plotting - however, this is unnecessary because we have loaded the `tidyverse` package which includes `ggplot2`, but GitHub Copilot doesn't know that. 
