...
💡 **Tip**: A common question we get is: what can Copilot "see" of my files and code? By default, Copilot can see code that you have highlighted or are working on in the open file. If you want Copilot to ignore your open file, you can click the eye button next to "Current file" in the chat to disable current file context. Copilot cannot see all the files in your folder automatically, however you can tell Copilot to look at other files in your project by adding them to your chat or Copilot Edits session. Copilot learns from everything you show it, so the more you use it, the better it will get. 
